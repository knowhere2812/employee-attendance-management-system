...
const features = [
  {
    ...
    text: "Check in, check out, and keep an accurate record of every workday.",
  },
  {
    icon: ClipboardCheck,
    title: "Leave management",
    text: "Apply for leave and track approvals and remaining balance in one place.",
  },
  {
    icon: BarChart3,
    title: "Clear HR insights",
    text: "Review attendance, employee status, and leave requests from one dashboard.",
  },
];
            ...
            <div className="absolute right-0 top-12 z-10 w-52 rounded-xl border border-slate-700 bg-slate-900 p-3 shadow-xl">
              ...
              <div className="space-y-2">
                <button
                  type="button"
                  onClick={goToLogin}
                  className="flex w-full items-center justify-between rounded-lg bg-slate-800 px-3 py-2 text-left text-sm text-slate-200 hover:bg-slate-700"
                >
                  <span>Employee</span>
                  <Users size={16} />
                </button>
      ...
      <section className="mx-auto grid max-w-6xl gap-12 px-5 py-20 md:grid-cols-[1.2fr_.8fr] md:items-center">
        <div>
          ...
          <h1 className="text-4xl font-bold leading-tight sm:text-6xl">
            Work attendance, made clear.
          </h1>
          <p className="mt-6 max-w-xl text-lg leading-8 text-slate-300">
            A focused workspace for employees to manage their day and for HR
            teams to make confident people decisions.
          </p>
        ...
        <div className="rounded-2xl border border-slate-700 bg-slate-900 p-6 shadow-2xl">
          ...
          <p className="mt-6 text-sm text-slate-400">
            Sign in to see your live workforce data.
          </p>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-6xl">
          <div className="mb-10 text-center">
            <p className="text-sm font-semibold uppercase tracking-[0.2em] text-brand-600">
              Why teams use WorkTrack
            </p>
            <h2 className="mt-3 text-3xl font-bold">
              Built for daily work clarity.
            </h2>
          </div>
